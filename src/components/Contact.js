    ...
    <section className='my-28' id='contact'>
      ...
      <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between'>
        <div className='md:w-6/12 md:px-0 p-5 my-5'>
          <div>
            <p className='font-bold'>Muruganandham Sivasankar</p>

            <a href='mailto: manosankar2000@gmail.com' className='border-b-2 mt-3 inline-block border-gray-500'>
              manosankar2000@gmail.com
            </a>
          </div>
          <a className='border-b-2 mt-3 inline-block border-gray-500' href='./Muruganandham.S__Resume.pdf' target='_blank' rel='noreferrer'>
            Resume
          </a>
          <SocialContact />
                ...
                <div className='flex flex-row flex-wrap mt-7'>
                  <div className='mr-4'>
                    <a href={item.link} rel="noreferrer" target="_blank">
                      <span className='mb-2 flex flex-row items-end  border-gray-500 p-2 text-sm'>
                        <img src={item.icon} className="mr-1" style={{ width: '24px', height: '24px', display: 'flex', flexDirection: 'row' }} />
                      </span>
                    </a>
                  </div>
                </div>
          ...
          {/* <div className='flex flex-row flex-wrap mt-7'>
            <div className='mr-4'>
              <a href='https://www.linkedin.com/in/muruganandham-sivasankar-524765181' target='_blank' rel='noreferrer'>
                <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
                  <img src='' alt='' width='24px' height='24px' className='mr-1' />
                  LinkedIn
                </span>
              </a>
            </div>
            ...
            <div className='mr-4'>
              <a href='https://github.com/manosankar11' target='_blank' rel='noreferrer'>
                <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
            ...
            <a href='https://www.instagram.com/mano_sankar_11/' target='_blank' rel='noreferrer'>
              <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
                <img src='./images/icons/instagram.png' alt='' width='24px' height='24px' className='mr-1' />
